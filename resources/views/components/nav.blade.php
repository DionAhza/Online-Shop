        ...
        <div class="container text-white">
          ...
          <div class="collapse navbar-collapse justify-content-end gap-2" id="navbarSupportedContent">
            <ul class="navbar-nav gap-3">
              ...
              <form class="d-flex" role="search" method="GET" action="{{ route('cari') }}">
                ...
                @auth
                    @if (Auth::user()->role === 'seller')
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('barang') }}">tambah produk</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="{{ route('toko', ['user' => auth()->user()->id]) }}">Lihat produk Anda</a></li>
                        </ul>
                    @endif
                @endauth
            </li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" href="{{ route('register.user') }}">Daftar sebagai pelanggan</a></li>
                  <li><a class="dropdown-item" href="{{ route('register.seller') }}">Daftar sebagai Penjual</a></li>
                </ul>
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{ route('cart') }}"><svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"><path d="M13.5 21c-.276 0-.5-.224-.5-.5s.224-.5.5-.5.5.224.5.5-.224.5-.5.5m0-2c-.828 0-1.5.672-1.5 1.5s.672 1.5 1.5 1.5 1.5-.672 1.5-1.5-.672-1.5-1.5-1.5m-6 2c-.276 0-.5-.224-.5-.5s.224-.5.5-.5.5.224.5.5-.224.5-.5.5m0-2c-.828 0-1.5.672-1.5 1.5s.672 1.5 1.5 1.5 1.5-.672 1.5-1.5-.672-1.5-1.5-1.5m16.5-16h-2.964l-3.642 15h-13.321l-4.073-13.003h19.522l.728-2.997h3.75v1zm-22.581 2.997l3.393 11.003h11.794l2.674-11.003h-17.861z"/></svg></a>
              </li>
              @endauth
              @auth
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  @auth
                    @if (Auth::user()->role === 'seller')
                  <li><a class="dropdown-item" href="{{ route('order') }}">Lihat Order</a></li>
                  @endif
                  @endauth
                </ul>
