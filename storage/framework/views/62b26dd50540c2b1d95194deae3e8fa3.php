        ...
        <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col">
                <div class="card h-100 shadow-lg border-0">
                    ...
                    <img src="<?php echo e(asset('img/' . $order->barang->gambar)); ?>" class="card-img-top rounded-top" alt="<?php echo e($order->barang->nama_barang); ?>" style="object-fit: cover; height: 200px;">
                    
                    <div class="card-body bg-light">
                        <h5 class="card-title fw-bold text-primary"><?php echo e($order->barang->nama_barang); ?></h5>
                        <p class="card-text"><strong>Pembeli: </strong><?php echo e($order->user->name); ?></p>
                        <p class="card-text"><strong>Jumlah: </strong><?php echo e($order->jumlah); ?></p>
                        <p class="card-text"><strong>Harga: </strong>Rp. <?php echo e(number_format($order->jumlah * $order->barang->harga, 0, ',', '.')); ?></p>
                        <p class="card-text"><strong>Alamat: </strong><?php echo e($order->user->alamat); ?></p>
                        <p class="card-text"><strong>Metode Pembayaran: </strong><?php echo e($order->pembayaran); ?></p>
                    </div>
